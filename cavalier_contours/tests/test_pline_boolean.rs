        ...
        rectangle_circle {
            (pline_closed![(0.0, 1.0, 1.0),(10.0, 1.0, 1.0)],
             ...
             => [(BooleanOp::OR, &[PlineProperties::new(10, 109.15381629282, 52.324068506275, 0.0, -10.0, 10.0, 10.0)], &[]),
                 (BooleanOp::NOT, &[PlineProperties::new(3, 29.336980664548, 23.492343031178, 6.0, -3.8989794855664, 10.0, 5.8989794855664),
                                    PlineProperties::new(3, 19.816835628274, 20.757946197186, 0.0, -3.5825756949558, 3.0, 5.5825756949558)], &[]),
                 (BooleanOp::AND, &[PlineProperties::new(4, 29.386000046923, 25.091858029623, 3.0, -4.0, 6.0, 6.0)], &[]),
                 (BooleanOp::XOR, &[PlineProperties::new(3, 29.336980664548, 23.492343031178, 6.0, -3.8989794855664, 10.0, 5.8989794855664),
                                    PlineProperties::new(3, 19.816835628274, 20.757946197186, -8.8817841970013e-16, -3.5825756949558, 3.0, 5.5825756949558),
                                    PlineProperties::new(4, -18.306999976538, 18.582818653767, 3.0, -10.0, 6.0, -3.5825756949558),
                                    PlineProperties::new(4, -12.306999976538, 14.582818653767, 3.0, 5.5825756949558, 6.0, 10.0), ], &[])
                ]
        }
