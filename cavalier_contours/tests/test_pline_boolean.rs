...
mod test_simple {
    ...
    declare_boolean_tests! {
        rectangle_slicing_circle {
            ...
            =>
            [
                (BooleanOp::OR, &[PlineProperties::new(10, 109.15381629282, 52.324068506275, 0.0, -10.0, 10.0, 10.0)], &[]),
                (BooleanOp::NOT, &[PlineProperties::new(3, 29.336980664548, 23.492343031178, 6.0, -3.8989794855664, 10.0, 5.8989794855664), PlineProperties::new(3, 19.816835628274, 20.757946197186, 0.0, -3.5825756949558, 3.0, 5.5825756949558)], &[]),
                (BooleanOp::AND, &[PlineProperties::new(4, 29.386000046923, 25.091858029623, 3.0, -4.0, 6.0, 6.0)], &[]),
                (BooleanOp::XOR, &[PlineProperties::new(3, 29.336980664548, 23.492343031178, 6.0, -3.8989794855664, 10.0, 5.8989794855664), PlineProperties::new(3, 19.816835628274, 20.757946197186, -8.8817841970013e-16, -3.5825756949558, 3.0, 5.5825756949558), PlineProperties::new(4, -18.306999976538, 18.582818653767, 3.0, -10.0, 6.0, -3.5825756949558), PlineProperties::new(4, -12.306999976538, 14.582818653767, 3.0, 5.5825756949558, 6.0, 10.0), ], &[])
            ]
        }
        rectangle_over_half_of_circle {
            ...
            =>
            [
                (BooleanOp::OR, &[PlineProperties::new(5, 8926.990816987241, 357.0796326794897, -50.0, -50.0, 50.0, 50.0)], &[]),
                (BooleanOp::AND, &[PlineProperties::new(3, 3926.9908169872415, 257.0796326794897, -50.0, 0.0, 50.0, 50.0)], &[]),
        ...
        rectangle_in_rectangle_one_edge_overlap {
            ...
            =>
            [
                (BooleanOp::OR, &[PlineProperties::new(6, 2500.0, 200.0, 0.0, 0.0, 50.0, 50.0)], &[]),
